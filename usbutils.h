...
int _usb_transfer_read(struct cgpu_info *cgpu, uint8_t request_type, uint8_t bRequest, uint16_t wValue, uint16_t wIndex, char *buf, unsigned int bufsiz, int *amount, unsigned int timeout, enum usb_cmds cmd);
